...
export class GrammarService {
  ...
  private grammarTable = new BehaviorSubject<any>({
    ...
    'has throve': 'has thriven, has thrived',
    ...
    'this phenomena': 'this phenomenon [singular]',
    ...
    'were been': 'have been, were being',
    ...
    'would comprise of': 'would comprise, would consist of',
    'would of': 'would have',
    ...
    '%er then': 'than',
    'base on': 'based on (\'base on\' may be acceptable, depending on context)',
    'its an': 'it\'s an',
  });
